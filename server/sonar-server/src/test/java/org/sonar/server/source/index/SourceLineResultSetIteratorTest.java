...
public class SourceLineResultSetIteratorTest {
  ...
  public void parse_db_and_generate_source_line_documents() throws Exception {
    ...
    FileSourceTesting.updateDataColumn(connection, "FILE_UUID", FileSourceTesting.generateFakeData(3));
    ...
    assertThat(firstLine.scmAuthor()).isEqualTo("a_guy");
    assertThat(firstLine.highlighting()).isEqualTo("2,9,k;9,18,k");
    assertThat(firstLine.symbols()).isEqualTo("SYMBOLS");
    assertThat(firstLine.source()).isEqualTo("this is not java code 1");
    assertThat(firstLine.utLineHits()).isEqualTo(1);
    assertThat(firstLine.utConditions()).isEqualTo(2);
    assertThat(firstLine.utCoveredConditions()).isEqualTo(1);
    assertThat(firstLine.itLineHits()).isEqualTo(1);
    assertThat(firstLine.itConditions()).isEqualTo(2);
    assertThat(firstLine.itCoveredConditions()).isEqualTo(1);
    assertThat(firstLine.overallLineHits()).isEqualTo(1);
    assertThat(firstLine.overallConditions()).isEqualTo(2);
    assertThat(firstLine.overallCoveredConditions()).isEqualTo(1);
    iterator.close();
  }
