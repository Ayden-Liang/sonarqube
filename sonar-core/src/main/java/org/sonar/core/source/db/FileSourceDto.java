...
public class FileSourceDto {
  ...
  public static FileSourceDb.Data deserializeData(byte[] binaryData) {
    // stream is always closed
    return deserializeData(new ByteArrayInputStream(binaryData));
  }
   ...
   */
  public static FileSourceDb.Data deserializeData(InputStream input) {
    LZ4BlockInputStream lz4Input = null;
    try {
      lz4Input = new LZ4BlockInputStream(input);
   ...
   */
  public static byte[] serializeData(FileSourceDb.Data protobuf) {
    ByteArrayOutputStream byteOutput = new ByteArrayOutputStream();
    LZ4BlockOutputStream compressedOutput = new LZ4BlockOutputStream(byteOutput);
    try {
      protobuf.writeTo(compressedOutput);
